...
else
{
    ...
    if ($result)
    {
    	...
    	while ($i < $num)
    	{
            ...
            $ndfps[$i]->urlsource = dol_buildpath('/ndfp/ndfp.php', 1).'?id='.$obj->rowid;
    ...
    if ($result)
    {
    	...
    	while ($i < $num)
    	{
            ...
            $unpaid_ndfps[$i]->url = $ndfpstatic->getNomUrl(1);
            ...
            $unpaid_ndfps[$i]->urlsource = dol_buildpath('/ndfp/ndfp.php', 1).'?id='.$obj->rowid;
    ...
    if ($result)
    {
    	...
    	while ($i < $num)
    	{
            ...
            $drafts[$i]->url = $ndfpstatic->getNomUrl(1);
            ...
            $drafts[$i]->urlsource = dol_buildpath('/ndfp/ndfp.php', 1).'?id='.$obj->rowid;
 ...
 * View
 */
include 'tpl/ndfp.index.tpl.php';
