...
class mod_ndfp_saturne extends ModeleNumRefNdfp
{
    ...
    function info()
    {
        ...
        $mask = isset($conf->global->NDFP_SATURNE_MASK) ? $conf->global->NDFP_SATURNE_MASK : '';
        $texte.= '<tr><td>'.$langs->trans("Mask").' :</td>';
        $texte.= '<td align="right">'.$form->textwithpicto('<input type="text" class="flat" size="24" name="mask" value="'.$mask.'">',$tooltip,1,1).'</td>';
