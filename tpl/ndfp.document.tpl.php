...
<table class="border" width="100%">
    <tr>
        ...
        <td colspan="5"><?php echo $html->showrefnav($object,'ref','',1,'ref','ref',''); ?></td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="5"><?php echo count($filearray); ?></td>
    </tr>

    <tr>
        <td><?php echo $langs->trans('TotalcountAttachedFiles'); ?></td>
...
<?php $formfile->form_attach_new_file($_SERVER["PHP_SELF"].'?id='.$object->id, '', 0, 0, $can_upload, 50, '', '', 1, '', 0); ?>


<?php $formfile->list_of_documents($filearray, $object, 'ndfp', '&id='.$object->id); ?>
