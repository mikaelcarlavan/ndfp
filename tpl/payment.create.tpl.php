...
$(document).ready(function() {
	$("#fillall").click(function() {
		$('input[name^="amount"]').val(function() { return $(this).attr('remain'); });
	});
	$("#fillnone").click(function() {
...
<table class="border" width="100%">
    ...
    <table class="noborder" width="100%">
        <tr class="liste_titre">
            ...
            <td align="center">
            	<?php echo $langs->trans('Amount'); ?><br />
            	<a href="#" id="fillall"><?php echo $langs->trans("Total") ?></a> / <a href="#" id="fillnone"><?php echo $langs->trans("None") ?></a>
            </td>
        </tr>
        ...
        <tr class="<?php echo ($i%2==0 ? 'impair' : 'pair'); ?>">
            <td>
                <a href="<?php echo dol_buildpath('/ndfp/ndfp.php', 1).'?id='.$payments[$i]->rowid; ?>">
            ...
            <td align="center">
                <?php if ($action == 'create'){?>
                    <input type="text" size="8" name="<?php echo 'amount_'.$payments[$i]->rowid; ?>" value="<?php echo isset($amounts[$payments[$i]->rowid]) ? $amounts[$payments[$i]->rowid] : ''; ?>" remain="<?php echo price($payments[$i]->total_ttc - $payments[$i]->total_paid); ?>" />
                <?php }else{ ?>
