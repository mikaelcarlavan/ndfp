...
echo $langs->trans('ExpPayCatDesc');
...
<br />
    ...
    <table class="noborder" width="100%">
		...
		<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            ...
            <td><?php echo $ndfpHtml->select_parent_payment_cats('', 'fk_parent'); ?></td>
        ...
        <tr class="liste_titre">
            ...
            <?php print_liste_field_titre($langs->trans("Autoclass"),$_SERVER['PHP_SELF'],"c.autoclass",($page?'page='.$page.'&':''),"",'align="center"',$sortfield,$sortorder); ?>
        ...
        <?php foreach ($cats as $id => $cat){ ?>
            ...
            <td>
                <?php if ($action == 'modify' && $id == $rowid){ ?>
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                        ...
                        <input type="hidden" name="autoclass" value="<?php echo $cat->autoclass; ?>" />
            ...
            <td>
                <?php if ($action == 'modify' && $id == $rowid){
                         echo $ndfpHtml->select_parent_payment_cats($cat->fk_parent, 'fk_parent');
                     }else{
