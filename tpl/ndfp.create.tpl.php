...
llxHeader('', $langs->trans("NewNdfp"), '', '', 0, 0, array('/ndfp/js/functions.js.php?rowid=0&id=0&fk_cat=0'));
...
<tr>
    ...
    <td colspan="2">
        <?php if ($user->rights->ndfp->allactions->create){
                echo $html->select_users(($ndfp->fk_user > 0 ? $ndfp->fk_user : $user->id), 'fk_user');
            }else{
...
<tr>
    ...
    <td colspan="2"><?php $formproject->select_projects(-1, $ndfp->fk_project, 'fk_project'); ?></td>
</tr>    
<?php } ?>
...
<tr>
    <td class="field"><?php echo $langs->trans('PaymentMode'); ?></td>
    <td colspan="2"><?php echo $ndfpHtml->select_payment_modes($ndfp->fk_mode_reglement,'fk_mode_reglement'); ?></td>
</tr>           

<!--
<tr>
    <td class="field"><?php echo $langs->trans('NoteAlreadyPaid'); ?></td>
    <td colspan="2"><?php $html->selectyesno('paid', $ndfp->paid); ?></td>
</tr> 
-->              
<tr>
	<td class="fieldrequired"><?php echo $langs->trans('DateStart'); ?></td>
	<td colspan="2"><?php echo $html->select_date($ndfp->datef, 'd', 0, 0, 0,"dates", 1, 1); ?></td>
</tr>

<tr>
	<td class="fieldrequired"><?php echo $langs->trans('DateEnd'); ?></td>
	<td colspan="2"><?php echo $html->select_date($ndfp->datef, 'f',0, 0, 0,"datee", 1, 1); ?></td>
</tr>

<tr>
    <td class="field"><?php echo $langs->trans('TaxRating'); ?></td>
    <td colspan="2">
...
<tr>
    <td class="field"><?php echo $langs->trans('PreviousExp'); ?></td>
    <td colspan="2"><input type="text" id="previous_exp" name="previous_exp" value="<?php echo $ndfp->previous_exp; ?>" size="52"/></td>
</tr>
