...
<td valign="top" width="30%" class="notopnoleft">
    <form method="post" action="<?php echo dol_buildpath('/ndfp/list.php', 1); ?>">
    ...
    <table class="noborder" width="100%">
        <tr class="liste_titre">
		  <td colspan="3"><?php echo $langs->trans("DraftNdfps").(count($drafts)?' ('.count($drafts).')':''); ?></td>
        </tr>
...
<?php } ?>
	...
	<table class="noborder" width="100%">
	   <tr class="liste_titre">
			<td colspan="2"><?php echo $langs->trans("NdfpToBill").(count($unpaid_ndfps)?' ('.count($unpaid_ndfps).')':''); ?></td>
			<td align="right"><?php echo $langs->trans("AmountTTC"); ?></td>
			<td align="right"><?php echo $langs->trans("Paid"); ?></td>
			<td width="16">&nbsp;</td>
	   </tr>
<?php if (count($unpaid_ndfps)) {
    $i = 0;
    ?>
